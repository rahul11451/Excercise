...
@else
    ...
    $log .= '/view/login.php" class="dropdown-item text-dark">Login</a></li><li class="nav-item">
...
<head>
    ...
    <link href="{{ SITE_URL }}/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    {{-- <!-- <link href="{{ SITE_URL }}/css/bootstrap.min.css" rel="stylesheet"> --> --}}
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css">
    <script src="{{ SITE_URL }}/css/bootstrap/js/bootstrap.bundle.min.js"></script>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow fixed-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="" class=" nav-item nav-link">{{ $siteName }}</a>
